...
def main(flag, num_data = 100, type_data = 'scaled', num_neigh = 5, control_HL1 = 32, control_HL2 = 0, cost_HL1 = 32, cost_HL2 = 0):
    if flag == 0:
    ...
    numpy.savetxt('knn_pred.txt',out_knn,delimiter=',')
    numpy.savetxt('knn_actual.txt',Y_train_knn[0],delimiter=',')

    numpy.savetxt('knn_descaled_pred.txt',out_knn*coeff_knn[3] + coeff_knn[2],delimiter=',')
    numpy.savetxt('knn_descaled_actual.txt',Y_train_knn[0]*coeff_knn[3] + coeff_knn[2],delimiter=',')
