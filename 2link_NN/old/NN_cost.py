...
data = '../training_data/final_data/final_cost_2_' + num_data + 'k_scaled_' + rep_parameter
...
if len(sys.argv) == 5:
    model.save('../trained_models/nn/cost/NN_cost_' + num_data + 'k_' + rep_parameter + '_H' + str(HL1) + '_H' + str(HL2))
else:
    model.save('../trained_models/nn/cost/NN_cost_' + num_data + 'k_' + rep_parameter + '_H' + str(HL1))
