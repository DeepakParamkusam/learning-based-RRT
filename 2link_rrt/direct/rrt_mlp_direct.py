...
#UNCONSTRAINED MODEL
# mlp_control = joblib.load('../../trained_models/mlp-direct-uncons-control-100-100.pkl')
# mlp_cost = joblib.load('../../trained_models/mlp-direct-uncons-cost-100-100.pkl')
...
def modelPredict(initialState,goalState):
	...
	predicted_control = mlp_control.predict(input2NN)
